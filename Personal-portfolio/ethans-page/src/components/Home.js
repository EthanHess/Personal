...
{/* style={{backgroundColor: theme === "NATURE" ? `white` : `rgb(10, 2, 51)`}} */}
          ...
          <div className="second_tabs">
            <div className="flipContainer_cosmologist">
